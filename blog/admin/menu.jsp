			...
			$("#tabs")
					.tabs(
							'add',
							{
								...
								iconCls : icon, //显示图标
								content : "<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src='${blog}/admin/"
										+ url + "'></iframe>"
							//url 远程加载所打开的url
							})
		}
...
<body class="easyui-layout">
			...
			<div class="easyui-accordion" data-options="fit:true,border:false">
				...
				<div title="博客管理" data-options="iconCls:'icon-bkgl'"
					...
					<a
						...
						class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-bkgl'"
				...
				<div title="博客类别管理" data-options="iconCls:'icon-bklb'"
					...
					<a
						...
						class="easyui-linkbutton"
						data-options="plain:true,iconCls:'icon-bklb'"
						style="width: 150px;">博客类别信息管理</a>
				</div>
				...
				<div title="系统管理" data-options="iconCls:'icon-system'"
					...
					<a href="#" class="easyui-linkbutton"
						...
						style="width: 150px;">刷新系统缓存</a> <a href="#"
						class="easyui-linkbutton"
	...
	<div region="south" style="height: 25px; padding: 5px" align="center">
		<div region="south" style="height: 25px; padding: 5px" align="center">
			Copyright © XXX的SSM博客系统 版权所有</div>
	</div>
</body>
</html>